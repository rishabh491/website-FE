...
import jpeg1 from ".././assets/recent1.jpeg";
import jpeg2 from ".././assets/recent2.jpeg";
import jpeg3 from ".././assets/recent3.jpeg";
// Hero Images
const heroImages = [
...
const testimonials = [
  {
    ...
    role: "Homeowner",
    image:
      "https://images.unsplash.com/photo-1556157382-97eda2d62296?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2Njl8MHwxfHNlYXJjaHwzfHxwcm9mZXNzaW9uYWwlMjBidXNpbmVzcyUyMHBlcnNvbiUyMHBvcnRyYWl0fGVufDB8fHx8MTc1NTc1OTcyOHww&ixlib=rb-4.1.0&q=85",
    rating: 5,
    review:
      "RV Home Sol transformed our house into a dream home! Their attention to detail and creative vision exceeded our expectations. The 3D designs helped us visualize everything perfectly.",
  },
  {
    name: "Rajesh Gupta",
    role: "Business Owner",
    image:
      "https://images.unsplash.com/photo-1584940121730-93ffb8aa88b0?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2Njl8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBidXNpbmVzcyUyMHBlcnNvbiUyMHBvcnRyYWl0fGVufDB8fHx8MTc1NTc1OTcyOHww&ixlib=rb-4.1.0&q=85",
    rating: 5,
    review:
      "Professional service from start to finish. Ram Vijay's team delivered our office renovation on time and within budget. Highly recommend their expertise in interior design.",
  },
  {
    name: "Anita Mehta",
    ...
    rating: 5,
    review:
      "Amazing work! They completely renovated our kitchen and living room. The modern design perfectly matches our lifestyle. Worth every penny!",
  },
  {
    name: "Vikram Singh",
    role: "Hotel Owner",
    image:
      "https://images.unsplash.com/photo-1584554376766-ac0f2c65e949?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2Njl8MHwxfHNlYXJjaHw0fHxwcm9mZXNzaW9uYWwlMjBidXNpbmVzcyUyMHBlcnNvbiUyMHBvcnRyYWl0fGVufDB8fHx8MTc1NTc1OTcyOHww&ixlib=rb-4.1.0&q=85",
    rating: 5,
    review:
      "Outstanding commercial interior design for our boutique hotel. Their creative approach and quality craftsmanship brought our vision to life beautifully.",
  },
];
...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div
        className="absolute bottom-32 right-16 w-32 h-32 bg-purple-500/20 rounded-full blur-xl float-animation"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="absolute top-1/2 left-1/4 w-16 h-16 bg-pink-500/20 rounded-full blur-xl float-animation"
      ...
      <div className="relative z-10 h-full flex items-center justify-center">
        <div className="max-w-4xl px-6 text-center text-white">
          ...
          >
            ...
            planning, and renovation expertise. Creating beautiful, functional
            spaces for over 20 years.
          </motion.p>
...
export default function Home() {
  return (
    <div className="w-full">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Our numbers speak for our commitment to excellence and client
              satisfaction
            </p>
          </motion.div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              solutions tailored to your unique style and needs
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore our recent projects and see how we transform spaces into
      ...
      <section id="process" className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A systematic approach to creating your dream space, from initial
      ...
      >
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width=%2240%22%20height=%2240%22%20viewBox=%220%200%2040%2040%22%20xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cg%20fill=%22none%22%20fill-rule=%22evenodd%22%3E%3Cg%20fill=%22%23ffffff%22%20fill-opacity=%220.05%22%3E%3Ccircle%20cx=%2220%22%20cy=%2220%22%20r=%221%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-50"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mb-16">
            {testimonials.map((testimonial, i) => (
              ...
              >
                ...
                <div className="relative">
                  <Quote
                    className="absolute -top-2 -left-2 text-indigo-400/40"
                    size={32}
                  />
              ...
              {[
                {
                  name: "Meera Patel",
                  review:
                    "Exceptional attention to detail and creative solutions!",
                },
                {
                  name: "Arjun Kumar",
                  review:
                    "Transformed our office space beyond our expectations.",
                },
                {
                  name: "Kavita Singh",
                  review: "Professional team with amazing design sense.",
                },
                {
                  name: "Rohit Sharma",
                  review: "Quality work delivered on time and within budget.",
                },
              ].map((review, i) => (
                <SwiperSlide key={i}>
      ...
      >
        <div className="absolute top-0 left-0 w-full h-full bg-[url('data:image/svg+xml,%3Csvg%20width=%22100%22%20height=%22100%22%20viewBox=%220%200%20100%20100%22%20xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cg%20fill-rule=%22evenodd%22%3E%3Cg%20fill=%22%234f46e5%22%20fill-opacity=%220.03%22%3E%3Cpath%20d=%22M50%2050c0-5.5%204.5-10%2010-10s10%204.5%2010%2010-4.5%2010-10%2010-10-4.5-10-10z%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-50"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="prose prose-lg text-gray-600 mb-8">
                <p className="text-xl leading-relaxed mb-6">
                  With over <strong>20 years of experience</strong> in the
                  interior design industry, RV Home Sol has been transforming
                  spaces and exceeding client expectations across Rajasthan.
                </p>

                <p className="leading-relaxed mb-6">
                  Founded by <strong>Ram Vijay Sahani</strong>, we specialize in
                  creating beautiful, functional spaces that reflect your
                  personality and lifestyle. Our comprehensive approach combines
                  traditional craftsmanship with modern design principles.
                </p>

                <p className="leading-relaxed">
                  From conceptual design to final implementation, we handle
                  every aspect of your project with meticulous attention to
            ...
            >
              <div className="relative bg-gradient-to-br from-indigo-600 to-purple-600 rounded-3xl p-8 shadow-2xl">
                ...
                <div
                  className="absolute -bottom-6 -left-6 w-20 h-20 bg-pink-400 rounded-full opacity-60 float-animation"
                  style={{ animationDelay: "2s" }}
                ></div>
              </div>
            </motion.div>
      ...
      >
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width=%2240%22%20height=%2240%22%20viewBox=%220%200%2040%2040%22%20xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cg%20fill=%22none%22%20fill-rule=%22evenodd%22%3E%3Cg%20fill=%22%23ffffff%22%20fill-opacity=%220.1%22%3E%3Ccircle%20cx=%2220%22%20cy=%2220%22%20r=%221%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-30"></div>
        ...
        >
          ...
          <p className="text-xl mb-12 text-white/90 leading-relaxed max-w-3xl mx-auto">
            Let's bring your design dreams to life. Contact us today for a free
            consultation and discover how we can create the perfect space for
            you.
          </p>
            ...
            {[
              {
                ...
                title: "Call Us",
                info: "+91 7568807817",
                action: "tel:+917568807817",
              },
              {
                icon: Mail,
                title: "Email Us",
                info: "ramvijaysahani49@gmail.com",
                action: "mailto:ramvijaysahani49@gmail.com",
              },
              {
                icon: MapPin,
                title: "Visit Us",
                info: "Makrana, Rajasthan",
                action: "#",
              },
            ].map((contact, i) => (
              <motion.a
